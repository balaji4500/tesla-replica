...
<input type="text" name="address" id="in1" required oninvalid="this.setCustomValidity('please enter your address')"
onvalid="this.setCustomValidity('')"><br><br>
<h6>Average Electric Bill</h6>
<input type="number" name="electric" id="in1" required oninvalid="this.setCustomValidity('please enter your electricbill')"
onvalid="this.setCustomValidity('')">
<br><br><br>
<a href="#" id="a1">My home is new or being built</a><br><br><br>
<input type="submit" value="Next" id="in2">
</form>
<br><br>
