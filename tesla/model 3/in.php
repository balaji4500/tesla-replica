...
<body>
  ...
  <div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
      ...
      <a class="navbar-brand" href="#" ms-auto>
        <h3>Model 3</h3>
      </a>
      <li id="li1" class="nav-item dropdown ms-auto">
        <a id="a2" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
  ...
  <div class="row">
    <div class="col-8">
      <img src="images/white.webp" id="change-img" class="img-fluid">
    </div>
    <div class="col-4"><br>
