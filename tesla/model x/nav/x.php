...
<body>
    <section id="main1">
        <div class="banner-image  w-100 vh-100   justify-content-center   align-items-center" id="img2">
...
<a href="#" id="a3">Schedule a Demo Drive</a>
</div>
<div  class="row" data-aos="fade-up">
    <div class="col"><h4>76 cu ft</h4> cargo  space</div>
    <div class="col"><h4>330 mi</h4> Range(EPA est.)</div>
    <div class="col"><h4>AWD</h4>  dual motor</div>
    <div class="col"><h4>AWD</h4>  dual motor</div>
    <div  class="col"><a href="http://localhost/phpprograms/tesla/account/acc.php"> <button id="btn">order now</button></a>
    </div>
</div>
...
<section id="main2">
    <div class="row">
   <div class="col-8">
        <img src="images/Slide13-1.jpg" id="img3" class="img-fluid">
        </div>
      <div  id="col1"class="col-4"> 
            <h5>Safety</h5>
            <h2 id="h2"> Designed for Safety</h2>
           <p>Safety is the most important part of every Tesla. We design our vehicles to exceed safety <br>
            standards.</p>    
        <h6>5-Star Rating</h6>
           ...
           <button id="btn1">view inventory</button>
...
<section id="main3">
    <div class="banner-image vh-100 justify-content-center   align-items-center" id="img3">
        <div class="text-center" data-aos="fade-up"><br><br><br><br>
            <h1>Model X Performance </h1><br>
